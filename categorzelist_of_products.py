...
if not os.path.exists(input_file):
    print(f"Input file '{input_file}' not found. Please create it and add your list.")
    exit(1)
...
try:
    ...
    print(f"\nCategorized grocery list has been successfully saved to '{output_file}'.")
except Exception as e:
    print("\nAn error occurred while communicating with Ollama:", str(e))
